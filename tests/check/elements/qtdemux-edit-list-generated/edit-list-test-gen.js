 ...
 *
 * Executing this file with node.js will update the following files in this directory:
 *
 *  - implementations.gen.cpp
 *  - calls.gen.cpp
 *
 * Does not require installing any other dependencies.
 */
...
fs.writeFileSync(__dirname + "/implementations.gen.c", gen_implementations());
fs.writeFileSync(__dirname + "/calls.gen.c", gen_calls());
